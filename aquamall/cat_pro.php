                ...
                <div class="shop_grid_product_area">
                    ...
                    <div class="row">
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class='product-img'><img src='admin/upload/{$row['pro_image']}' alt=''>";
                            ...
                            <a href='single-product-details.php?product_id={$row['product_id']}&product_name={$row['product_name']}'>"; 
                            echo "<h6>{$row['product_desc']}</h6>";
                            echo "</a>";
                            echo "<p class='product-price'>{$row['product_price']}$</p> </div></div>
                            </div>
                            </div>
                            ";
